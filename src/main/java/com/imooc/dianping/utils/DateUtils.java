package com.imooc.dianping.utils;
...
public class DateUtils {
     ...
     * @throws ParseException
     */
    public static Date dateParse(long dateTimeString, String pattern) throws ParseException {
        String format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date(dateTimeString));
        if (StringUtils.isBlank(pattern)) {
            pattern = DateUtils.DATE_PATTERN;
        }
        SimpleDateFormat sdf = new SimpleDateFormat(pattern);
