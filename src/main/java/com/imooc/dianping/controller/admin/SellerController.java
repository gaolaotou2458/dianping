...
public class SellerController {
    ...
    public ModelAndView index(PageQuery pageQuery){
        ...
        List<Seller> sellerModelList = sellerMapper.selectAll();
    ...
    public String create(@Valid  SellerCreateReq sellerCreateReq, BindingResult bindingResult) throws BusinessException {
        ...
        sellerModel.setRemarkScore(BigDecimal.valueOf(0));
        sellerMapper.insert(sellerModel);
    ...
    public CommonRes down(@RequestParam(value="id")Integer id) throws BusinessException {
        Seller sellerModel = sellerMapper.selectByPrimaryKey(id);
        sellerModel.setDisabledFlag(1);
